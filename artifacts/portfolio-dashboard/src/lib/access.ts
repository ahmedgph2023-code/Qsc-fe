...
export const ROUTE_ACCESS: Record<string, NavAccess> = {
  ...
  "/invoice-report": { roles: ["admin", "pm", "approver", "compliance", "viewer"] },
  "/firm-portfolio": { roles: ["admin", "pm", "approver", "compliance", "viewer"] },
  "/investment-orders": { roles: ["admin", "pm", "approver", "compliance", "viewer"] },
